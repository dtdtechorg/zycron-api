...
class Telegram
{
    ...
    public function sendMessageID(array $content)
    {
	...
	* </table>
     ...
     */
    public function buildInlineKeyboardButton($text, $url = '', $callback_data = '', $switch_inline_query = null, $switch_inline_query_current_chat = null, $callback_game = '', $pay = '', $web_app_url = '') {
        $replyMarkup = [
            'text' => $text,
        ];
        ...
        if ($url != '') {
            ...
            $replyMarkup['pay'] = $pay;
        } elseif ($web_app_url != '') { // WebApp ni qo‘llab-quvvatlash
            $replyMarkup['web_app'] = ['url' => $web_app_url];
        }
